...
import type { AppState, Story, Sprint } from "../types";

type AiTab = "project" | "stories" | "sprint" | "story";
      ...
      {showConfig && (
        <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 mt-1">Modèles compatibles : o1, o3, o4, gpt-5, deepseek-r1, etc.</p>
          </div>
